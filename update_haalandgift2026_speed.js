...
console.log('=== UPDATING ERLING HAALAND GIFT 2026 (p259) SPEED STATS ===');
...
console.log('Updated mockData.js with new p259 max speed stats.');
...
if (p259) {
  ...
  console.log('   maxEnhanced speed:', JSON.stringify(p259.maxEnhanced.baseStats.speed), JSON.stringify(p259.maxEnhanced.detailStats.speed));
}
