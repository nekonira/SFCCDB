...
console.log('=== UPDATING ERLING HAALAND GIFT 2026 (p259) STATS ===');
...
const newP259Obj = `{
    ...
    maxEnhanced: {
      overall: 12258,
      baseStats: { shoot: 2428, pass: 1984, dribble: 2360, defense: 1723, physical: 2342, speed: 1421 },
      detailStats: {
...
console.log('Updated mockData.js with new p259 max stats.');
...
if (p259) {
  ...
  console.log('   baseStats:', JSON.stringify(p259.baseStats));
  console.log('   maxEnhanced baseStats:', JSON.stringify(p259.maxEnhanced.baseStats));
}
