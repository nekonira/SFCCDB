...
console.log('=== UPDATING YOSHIO KOIZUMI 2026 (p190) ===');
...
console.log('mockData.js updated with p190 (OMF / パサーAM) in UTF-8.');
...
console.log('Verification of p190:', p190 ? `${p190.name} (${p190.mainPosition} / ${p190.playStyle})` : 'MISSING');
