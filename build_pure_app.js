...
console.log('--- Building Pure JavaScript App & Standard HTML5 ---');
...
console.log(`1. Transpiled src/app.jsx -> src/app.js (${appResult.code.length} bytes)`);
...
console.log(`2. Transpiled src/main.jsx -> src/main.js (${mainResult.code.length} bytes)`);
...
console.log(`3. Generated index.html linking ${imageFiles.length} player photos (${htmlContent.length} bytes)`);
