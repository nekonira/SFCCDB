...
console.log('=== UPDATING ERLING HAALAND GIFT 2026 (p259) ABILITY RANK ===');
...
console.log('Updated mockData.js with p259 ability rank 銅 for アジャイルキッカー.');
...
if (p259) {
  console.log('   Abilities:', JSON.stringify(p259.abilities));
}
